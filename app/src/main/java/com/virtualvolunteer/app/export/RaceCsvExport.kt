...
object RaceCsvExport {
    ...
    fun writeTimesCsv(context: Context, race: RaceEntity, rows: List<ParticipantDashboardDbRow>): File {
        ...
        sb.append("STARTOFEVENT,")
            .append(RaceUiFormatter.formatDateTimeWithSeconds(gun))
            .append(',')
            .append(version)
            .append('\n')
        finishers.forEachIndexed { index, row ->
            ...
            sb.append(index).append(',')
                .append(RaceUiFormatter.formatDateTimeWithSeconds(ft)).append(',')
        ...
        sb.append("ENDOFEVENT,").append(RaceUiFormatter.formatDateTimeWithSeconds(endTime)).append('\n')
    ...
    fun writeParticipantsCsv(context: Context, race: RaceEntity, rows: List<ParticipantDashboardDbRow>): File {
        ...
        val sb = StringBuilder()
        val version = ExportVersionLabel.get()
        val headerTime = RaceUiFormatter.formatDateTimeWithSeconds(System.currentTimeMillis())
